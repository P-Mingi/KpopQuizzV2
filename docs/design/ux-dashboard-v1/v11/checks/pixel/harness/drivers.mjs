...
export const STATES = {
  ...
  'play-answered': {
    ...
    lm: [
      ...
      { name: 'answers', proto: '.answers', impl: '.p4-answers', box: ['x', 'w'] },
      { name: 'answer buttons', proto: '.answers > *', impl: '.p4-answers .p4-ans', seq: true, styles: false },
      { name: 'answer right', proto: '.answers .ans.ok', impl: '.p4-ans.is-ok', box: ['w', 'h'], phoneBox: ['w'], why: 'phone: the real answer text wraps' },
      { name: 'answer picked wrong', proto: '.answers .ans.no', impl: '.p4-ans.is-no', box: ['w', 'h'], phoneBox: ['w'], why: 'phone: the real answer text wraps' },
      { name: 'answer rest', proto: '.answers .ans.rest', impl: '.p4-ans:not(.is-ok):not(.is-no)', box: ['w', 'h'], phoneBox: ['w'], why: 'phone: the real answer text wraps' },
  ...
  'end-guest': {
    ...
    lm: [...NAV,
      ...
      { name: 'photocard', proto: '.pcard', impl: '.p4-pcard', box: ['x', 'y', 'w', 'h'], skip: ['background-image', 'background-color', 'color', 'border-top-color'], why: 'photo; the container colour is not drawn (every text child sets white, same as the reference)' },
      { name: 'result column', proto: '.res-in', impl: '.p4-res-in', box: ['x', 'w'] },
      { name: 'xp line', proto: '.xpline', impl: '.p4-xpline', box: ['x', 'y', 'w', 'h'] },
      { name: 'result actions', proto: '.resact', impl: '.p4-resact', box: ['x', 'w', 'h'] },
      { name: 'keep playing', proto: '.res-in > section.sec', impl: '.p4-keep', box: ['x', 'w'] },
    ],
  },
  end: {
    owner: 'P4', auth: 'user', shot: 'full',
  ...
  share: {
    ...
    lm: [
      { name: 'share sheet', proto: '#share', impl: '.ux-layer .ux-sheet', box: ['vx', 'vy', 'w', 'h'] },
      { name: 'sheet header', proto: '#share .sh-h', impl: '.ux-layer .ux-sh-h', box: ['w', 'h'] },
      { name: 'sheet title', proto: '#share .sh-h h3', impl: '.ux-layer .ux-sh-h h2', box: ['h'] },
      { name: 'mini card', proto: '#share .minicard', impl: '.ux-layer .ux-minicard', box: ['vx', 'vy', 'w', 'h'] },
      { name: 'share grid', proto: '#share .shgrid', impl: '.ux-layer .ux-shgrid', box: ['vx', 'vy', 'w', 'h'] },
    ],
  },
  'create-1': {
  ...
  signin: {
    ...
    lm: [
      { name: 'sign-in sheet', proto: '#signin', impl: '.ux-layer .ux-sheet', box: ['vx', 'vy', 'w', 'h'] },
      { name: 'sheet header', proto: '#signin .sh-h', impl: '.ux-layer .ux-sh-h', box: ['w', 'h'] },
      { name: 'sheet title', proto: '#signin .sh-h h3', impl: '.ux-layer .ux-sh-h h2', box: ['h'] },
      { name: 'auth buttons', proto: '#signin .sh-b > div:not(.or)', impl: '.ux-layer .ux-authbs', box: ['vx', 'vy', 'w', 'h'] },
    ],
  },
  blindtest: {
  ...
  'blindtest-group-search': {
    owner: 'P6', auth: 'user', shot: 'full',
    open: async (page) => { await openBlindtest(page); await page.locator('.p6-gsearch input').fill('nct'); await page.locator('.p6-gsearch input').blur(); await page.mouse.move(1, 1); await page.waitForTimeout(500); },
    lm: [...NAV,
      { name: 'group search', proto: '.gsearch', impl: '.p6-gsearch', box: ['w', 'h'] },
      { name: 'group index item', proto: '.gi', impl: '.p6-gi', box: ['w', 'h'] },
    ],
  ...
  editor: {
    ...
    lm: [
      { name: 'editor sheet', proto: '#editor', impl: '.p8-ed', box: ['vx', 'vy', 'w', 'h'] },
      { name: 'sheet header', proto: '#editor .sh-h', impl: '.p8-ed .ux-sh-h', box: ['w', 'h'] },
      { name: 'first field', proto: '#editor .field', impl: '.p8-ed .ux-field', box: ['vx', 'vy', 'w'] },
  ...
  'hub-blackpink': {
    ...
    lm: [...NAV,
      ...
      { name: 'lower grid main', proto: '#hb-low > div:first-child', impl: '.p3-low-main', box: ['x', 'w'] },
      { name: 'lower grid side', proto: '#hb-low > div:last-child', impl: '.p3-low-side', box: ['x', 'w'] },
      { name: 'section title', proto: '.sec-h h2', impl: '.ux-sec-h h2', box: ['h'] },
  ...
  'hub-empty': {
    ...
    lm: [...NAV,
      { name: 'crumb', proto: '.crumb', impl: '.p3-hub .ux-crumb', box: ['x', 'y', 'w'] },
      { name: 'hub hero', proto: '.hub2', impl: '.p3-hero', box: ['x', 'y', 'w'] },
      { name: 'hub text column', proto: '.hub2 > div', impl: '.p3-hero-main', box: ['x', 'w'] },
      { name: 'hub actions', proto: '#hb-act', impl: '.p3-hero .p3-actions', box: ['x', 'w', 'h'] },
      { name: 'primary button', proto: '.btn-primary', impl: '.p3-actions .ux-btn-primary', box: ['h'] },
    ],
  },
  ...
  'header-sheet': {
    ...
    lm: [
      { name: 'header sheet', proto: '#hsheet', impl: '.ux-layer .ux-sheet', box: ['vx', 'vy', 'w', 'h'] },
      { name: 'sheet header', proto: '#hsheet .sh-h', impl: '.ux-layer .ux-sh-h', box: ['w', 'h'] },
