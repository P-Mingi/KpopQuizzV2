...
// REFONTE P1: notifyRunBeaten (the "someone beat your run" battle notification,
// link_url /battle) was removed with the battle/duel feature. Its only caller was
// the deleted battle result API.
