...
export function QuizCard({ quiz, isOwner, isLiked = false }: QuizCardProps): React.ReactElement {
  ...
  const hasBanner = (quiz.quiz_type === 'image' || quiz.quiz_type === 'intruder') && quiz.cover_image_url;

  return (
    <div className="relative bg-surface-primary border border-border-light rounded-lg overflow-hidden hover:border-border-medium transition-colors">
      ...
      <div className="p-4">
        <div className="flex justify-between items-start relative pointer-events-none">
          ...
          <div className="flex flex-col items-center flex-shrink-0">
            ...
            {hasBanner ? (
              <span className="text-xs text-txt-secondary whitespace-nowrap mt-1">
