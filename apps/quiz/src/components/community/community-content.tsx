...
// same community renders under whichever world's chrome you are in. It carries NO
// chrome (no header/nav/footer/toggle) and takes no world prop - it renders into
// the layout's <main>, and the surrounding shell is chosen by path per world.ts.
// Page-level concerns (metadata, canonical, ISR revalidate) stay on each route.
