...
export default function VersePromisesPage(): React.ReactElement {
  return (
    <div className="verse-scope" style={{ maxWidth: 640, margin: '0 auto', padding: '48px 4px 120px' }}>
      <p style={{ fontSize: 11, fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.16em', color: '#7c5cfc' }}>KpopVerse · the covenant</p>
      ...
      <Link href="/verse" style={{ display: 'inline-flex', alignItems: 'center', gap: 6, marginTop: 24, fontSize: 14, fontWeight: 700, color: '#7c5cfc', textDecoration: 'none' }}>
        Back to Fandoms
