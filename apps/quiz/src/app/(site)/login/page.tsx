    ...
    <div className="login-wrap">
      <div className="login">
        ...
        <div className="auth-panel">
          ...
          {/* K5 - light Discord line reinforcing the OAuth (B23). */}
          <div className="auth-guest" style={{ marginTop: 2 }}>
            <a
              className="discord-login-line"
              href="https://discord.gg/X7AW95WFT?utm_source=discord&utm_medium=site&utm_campaign=login"
              target="_blank"
            ...
            >
              ...
              or join our Discord community &rarr;
            </a>
          </div>
