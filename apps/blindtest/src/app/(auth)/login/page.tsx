    ...
    <div className="px-5 pt-12 pb-8">
      ...
      <div className="space-y-3 mb-6">
        <button
          ...
          className="w-full flex items-center justify-center gap-3 py-3.5 rounded-[14px] bg-bg-secondary border border-border-default text-sm font-medium text-text-primary hover:border-border-hover transition-colors"
        >
